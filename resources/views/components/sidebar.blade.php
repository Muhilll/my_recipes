        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'pengguna' ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class='{{ Request::is('pengguna/user') ? 'active' : '' }}'>
                        <a class="nav-link" href="{{ route('admin.pengguna.user') }}">
                            User
                        </a>
                    </li>
            ...
            <li class="{{ Request::is('ulasan') ? 'active' : '' }}">
                <a class="nav-link" href="{{route('admin.ulasan')}}"><i class="fa fa-comments"></i>
                    <span>Ulasan</span>
                </a>
            </li>
